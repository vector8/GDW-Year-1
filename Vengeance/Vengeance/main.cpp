...
{
	InputManager::getInstance()->keyboardDown(key, x, y);
}
...
{
	InputManager::getInstance()->keyboardUp(key, x, y);
}
...
{
	InputManager::getInstance()->mouseClicked(button,state,x,y);
	glutPostRedisplay();
}
...
{
	InputManager::getInstance()->mouseMoved(x,y);
	glutPostRedisplay();
}
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Hexteria: Vengeance");
