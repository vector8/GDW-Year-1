...
public:
	...
	void initialize(int numAnimations, int frameWidth, int frameHeight, float posX, float posY, float layerID);
	...
	void setCurrentAnimation(int anim) {
		...
		if((unsigned)currentAnimation >= animations.size()) currentAnimation = 0;
	}
	/* update */
